...
save_name=exp/Track2_TD-SV-FreeText
yaml_name=Track2_TD-SV-FreeText.yaml

mkdir -p $save_name/model
cp $ti_model_location $save_name/model/model000000001.model
name=$yaml_name
python trainSpeakerNet_track2_td-sv-freetext.py --config yaml/$name --distributed >> log/$name.log
COMMENT
...
ti_model_location=exp/ti_model/model/model000000015.model
save_name=exp/Track2_TD-SV
yaml_name=Track2_TD-SV.yaml

mkdir -p $save_name/model
cp $ti_model_location $save_name/model/model000000001.model
name=$yaml_name
python trainSpeakerNet_track2_td-sv.py --config yaml/$name --distributed >> log/$name.log
