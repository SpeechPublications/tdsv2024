...
from SpeakerNet_tdsv2024 import *
from DatasetLoader import * #Datasetloader is kept same, becuase not doing anyy changes
...
parser.add_argument('--train_list',     type=str,   default="data/task2_td-sv-freetext_trainlist.txt",  help='Train list');
parser.add_argument('--test_list',      type=str,   default="data/test_list.txt",   help='Evaluation list');
parser.add_argument('--train_path',     type=str,   default="/DATA/sreekanth/tdsv", help='Absolute path to the train set'); 
parser.add_argument('--test_path',      type=str,   default="/DATA/sreekanth/voxceleb/voxceleb_1/test/wav", help='Absolute path to the test set'); 
parser.add_argument('--musan_path',     type=str,   default="/DATA/sreekanth/voxceleb/musan_split", help='Absolute path to the test set'); 
parser.add_argument('--rir_path',       type=str,   default="/DATA/sreekanth/voxceleb/RIRS_NOISES/simulated_rirs", help='Absolute path to the test set');
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        os.environ['MASTER_ADDR'] = "127.0.1.4"
        os.environ['MASTER_PORT'] = "8874"
